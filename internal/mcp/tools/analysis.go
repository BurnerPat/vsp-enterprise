...
func AnalysisToolDefs() []types.ToolDef {
	return []types.ToolDef{
		...
		), Handler: HandleGetCallGraph, ReadOnly: true, Focused: true,
		...
		), Handler: HandleGetObjectStructure, ReadOnly: true, Focused: true,
		...
		), Handler: HandleCompareCallGraphs, ReadOnly: true},
