...
func DevToolDefs() []types.ToolDef {
	return []types.ToolDef{
		...
		), Handler: HandleSyntaxCheck, ReadOnly: true, Focused: true},
		...
		), Handler: HandleActivate, Focused: true},
		...
		), Handler: HandleActivatePackage, Focused: true},
		...
		), Handler: HandleRunUnitTests, ReadOnly: true, Focused: true, Groups: []string{"T"}},
		...
		), Handler: HandleRunATCCheck, ReadOnly: true, Focused: true, Groups: []string{"T"}},
		...
		), Handler: HandlePrettyPrint, ReadOnly: true, Focused: true},
		...
		), Handler: HandleGetInactiveObjects, ReadOnly: true, Focused: true},
