...
// grepSourceToolDefs returns tool definitions for grep tools defined in this file.
func (s *Server) grepSourceToolDefs() []toolDef {
	return []toolDef{
		...
		},
		{
			...
			handler: s.handleGrepPackages,
		},
	}
}

// fileSourceToolDefs returns tool definitions for file import/export tools defined in this file.
func (s *Server) fileSourceToolDefs() []toolDef {
	return []toolDef{
		...
		},
		{
			...
			handler: s.handleSaveToFile, // Reuse existing handler
		},
	}
}
